...
class BluetoothManager:
    def __init__(self):
        ...
        try:
            ...
            logger.warning("BlueZ D-Bus unavailable: %s", e)
    ...
    def set_active_device(self, mac: str):
        ...
        if self._bus and mac:
            ...
            try:
                ...
                logger.warning("Could not get device proxy for %s: %s", mac, e)
    ...
    def switch_to_hfp(self):
        ...
        try:
            ...
            logger.error("switch_to_hfp failed: %s", e)
    ...
    def switch_to_a2dp(self):
        ...
        try:
            ...
            logger.error("switch_to_a2dp failed: %s", e)
    ...
    def _watch_signals(self):
        ...
        try:
            ...
            # when the A2DP→HFP profile switch completes.
            if self._active_mac:
            ...
            logger.error("BlueZ signal watch failed: %s", e)
